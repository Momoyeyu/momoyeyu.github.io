...
// An optional `class` prop also gives the component a non-empty Props type;
// without it Svelte infers `Record<string, never>`, whose index signature
// rejects Astro client directives (e.g. `client:only`) at type-check time.
